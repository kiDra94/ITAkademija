...
#Koristimo modul datetime za definisanje vremena
...
#cuvamo trenutan datum i vreme

#formatiramo ga u odredjenom formatu
...
curr_time = datetime.now()
#cuvamo trentno vreme

formatted_time = curr_time.strftime('%H:%M:%S:%f')
#formatiramo vreme u odredjenom formatu
print(formatted_time)
