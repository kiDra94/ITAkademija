...
class Employee:
    ...
    def __init__(self, root):
        ...
        B_Search = Button(Frame2, text="SEARCH", width=10, command=self.search_data).grid(row=0, column=3, padx=10,
                                                                                          pady=15)
        B_Show = Button(Frame2, text="SHOW ALL", width=10, command=self.displayData).grid(row=0, column=4, padx=10,
                                                                                          pady=15)
