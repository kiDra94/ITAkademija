...
def calculate_ci():
    ...
    #velikim slovima CI znaci da je konstanta!!!
    CI = principal * (pow((1 + rate / 100), time))
    #naredne cetiri crte onemugucavaju unos podatka u polje gdje racuna CI
    compound_field.config(state='normal')
    compound_field.delete(0, END)
    compound_field.insert(10, CI)
    compound_field.configure(state="disabled")


def clear_all():
    #END stoji na kraju, takva je sintaksa
...
if __name__ == "__main__":
    ...
    label4 = Label(root, text="Compound Interest : ",
                   fg='black', bg='tomato')
    #raspored labela inace se nece vidjeti dok ne ubacimo grid!
    ...
    root.mainloop() #uvijek na kraju; pokrece program