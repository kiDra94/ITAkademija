...
class Employee:
    def __init__(self, root):
        ...
        B_Update = Button(Frame1in, text="UPDATE", width=10, command=self.update_data).grid(row=0, column=1, padx=10,
                                                                                            pady=15)
        B_Del = Button(Frame1in, text="DELETE", width=10, command=self.delete_data).grid(row=0, column=2, padx=10,
                                                                                         pady=15)
        B_Clear = Button(Frame1in, text="CLEAR", width=10, command=self.clear_data).grid(row=0, column=3, padx=10,
                                                                                         pady=15)
    ...
    def displayData(self):
        con = mysql.connector.connect(host='localhost', user='root', database='off', password='', port=3306)
        cur = con.cursor()
    ...
    def search_data(self):
        con = mysql.connector.connect(host='localhost', user='root', database='off', port=3306)
        cur = con.cursor()
