...
class Employee:
    def __init__(self, root):
        ...
        T_Eno = Entry(Frame1, font=("verdana", 12, "bold"), bd=5, relief=GROOVE)
        ...
        T_Name = Entry(Frame1, font=("verdana", 12, "bold"), bd=5, relief=GROOVE)
        ...
        T_Dept = Entry(Frame1, font=("verdana", 12, "bold"), bd=5, relief=GROOVE)
        ...
        C_Gender = ttk.Combobox(Frame1, font=("verdana", 12, "bold"), state="readonly")
        ...
        B_Add = Button(Frame1in, text="ADD", width=10).grid(row=0, column=0, padx=10, pady=15)
        B_Update = Button(Frame1in, text="UPDATE", width=10).grid(row=0, column=1, padx=10, pady=15)
        B_Del = Button(Frame1in, text="DELETE", width=10).grid(row=0, column=2, padx=10, pady=15)
        B_Clear = Button(Frame1in, text="CLEAR", width=10).grid(row=0, column=3, padx=10, pady=15)
        ...
        C_Search = ttk.Combobox(Frame2, font=("verdana", 12, "bold"), state="readonly")
        C_Search['values'] = ("EmpNo", "Name", "Department", "Gender", "Address")
        C_Search.grid(row=0, column=1, padx=20, pady=10)

        T_Search = Entry(Frame2, font=("verdana", 12, "bold"), bd=5, relief=GROOVE)
        T_Search.grid(row=0, column=2, padx=20, pady=10, sticky="w")

        B_Search = Button(Frame2, text="SEARCH", width=10).grid(row=0, column=3, padx=10, pady=15)
        B_Show = Button(Frame2, text="SHOW ALL", width=10).grid(row=0, column=4, padx=10, pady=15)
